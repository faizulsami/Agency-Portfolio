...
const Footer = () => {
  ...
  <div className="mx-auto max-w-5xl px-4 py-16 sm:px-6 lg:px-8">
    <div className="flex justify-center text-teal-600">
      <img className='w-full' src="/public/Craflex Logo.png" alt="" />
    </div>
    <p className="mx-auto mt-6 max-w-md text-center leading-relaxed text-white">
    We're here to help. Contact us directly, and our team will provide you with the personalised support you need.
    </p>
