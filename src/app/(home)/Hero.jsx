    ...
    return (
        ...
        <svg className="bottom-left" width="232" height="191" viewBox="0 0 232 191" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <g opacity="0.1">
            ...
            //         <button className="border hover:relative hover:top-1  border-cyan-400 p-2 rounded-lg">View Source</button></div>
            ...
            //         <h1 className="text-center text-5xl md:text-9xl text-gray-500">Powerful <br />
            //             UI Design
            //             <br/> Tool</h1>
