const Hero = () => {
    return (
        <section className="bg-gray-700 relative" style={{ backgroundImage: 'radial-gradient(at 46% 52%, rgb(251, 191, 36) 0, transparent 42%)' }}>
            <section className="md:my-4">
                <div className="text-right mb-28"><button className="border hover:relative hover:top-1  border-cyan-400 p-2 rounded-lg">View Source</button></div>
                <svg className="grid-svg pb-80 md:pb-0 absolute" viewBox="150 350 702 750" fill="none">
                ...
                <div>
                    <h1 className="text-center text-5xl md:text-8xl text-gray-500">Powerful <br />
                        UI Design
                        Tool</h1>
                </div>
                <div className="my-28"><button className="border hover:relative hover:top-1  border-cyan-400 p-2 rounded-lg">View Source</button></div>
                <div className="text-right mb-28"><button className="border hover:relative hover:top-1  border-cyan-400 p-2 rounded-lg">View Source</button></div>
            </section>
        </section>
    );
