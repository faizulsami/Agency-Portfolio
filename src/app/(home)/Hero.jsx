const Hero = () => {
    return (
        <div className="hero">
            ...
            <a href="https://dribbble.com/shots/23181733-Blurry-Glassmorphic-Modern-Landing-page" target="_blank" className="button first">
                <button className="hero-btn">View Source</button>
